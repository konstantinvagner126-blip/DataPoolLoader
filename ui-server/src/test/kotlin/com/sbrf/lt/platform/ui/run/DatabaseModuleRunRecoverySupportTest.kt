...
class DatabaseModuleRunRecoverySupportTest {
    ...
    private class InMemoryDatabaseRunStore(
    ...
    private class StubDatabaseModuleRegistryOperations : DatabaseModuleRegistryOperations {
        override fun listModules(includeHidden: Boolean): List<ModuleCatalogItemResponse> = error("not used in this test")
        override fun loadModuleDetails(moduleCode: String, actorId: String, actorSource: String): DatabaseEditableModule = error("not used in this test")
        ...
        override fun createModule(
            ...
            actorDisplayName: String?,
            originKind: String,
            request: com.sbrf.lt.datapool.db.registry.model.RegistryModuleDraft,
        ) = error("not used in this test")

        override fun deleteModule(moduleCode: String, actorId: String) = error("not used in this test")
    }

    private class StubUiCredentialsProvider : UiCredentialsProvider {
