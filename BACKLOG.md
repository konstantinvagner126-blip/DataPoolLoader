...
- довести визуальную форму до DB-режима, чтобы редактирование DB-модулей шло через тот же UX;
...
- выровнять UX истории между файловым и DB-режимом;
...
1. Довести визуальный редактор конфига до DB-режима и закрыть remaining gaps.
2. Дочистить историю запусков и summary UX в файловом и DB-режимах.
3. Реализовать cleanup DB run-history.
4. Добить справку и общий UX до консистентного пользовательского уровня.
5. Завершить SQL-консоль:
   - избранные запросы;
   - расширенные guardrails.
6. Metadata и валидация модулей как единый слой.
7. Retention output-каталогов.
8. Структурирование DTO и `data class`.
9. Дальнейший refactoring крупных классов и стабилизация внутренних API.
10. Launcher-скрипты и onboarding.
11. `multi-statement SQL`.
