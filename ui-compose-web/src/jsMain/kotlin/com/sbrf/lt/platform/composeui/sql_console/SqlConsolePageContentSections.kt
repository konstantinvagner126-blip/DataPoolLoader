    ...
    Div({ classes("row", "g-4") }) {
        ...
        Div({ classes("col-12", "col-xl-9") }) {
            SqlConsoleWorkspacePanel(
                ...
                onOpenExecutionHistory = callbacks.onOpenExecutionHistory,
                ...
                onExplainCurrent = callbacks.onExplainCurrent,
                onExplainAnalyzeCurrent = callbacks.onExplainAnalyzeCurrent,
                onExplainSelection = callbacks.onExplainSelection,
                onExplainAnalyzeSelection = callbacks.onExplainAnalyzeSelection,
