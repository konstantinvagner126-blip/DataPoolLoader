...
internal data class SqlConsolePageUiState(
    ...
    val selectedSqlText: String = "",
    val selectedSqlLineCount: Int = 0,
...
internal data class SqlConsolePageCallbacks(
    ...
    val onApplyExecutionHistory: (SqlConsoleExecutionHistoryEntry) -> Unit,
    val onRepeatExecutionHistory: (SqlConsoleExecutionHistoryEntry) -> Unit,
    ...
    val onExplainCurrent: () -> Unit,
    val onExplainAnalyzeCurrent: () -> Unit,
    val onExplainSelection: () -> Unit,
    val onExplainAnalyzeSelection: () -> Unit,
    val onRunCurrent: () -> Unit,
    val onRunSelection: () -> Unit,
    val onRunAll: () -> Unit,
    val onStop: () -> Unit,
    val onCommit: () -> Unit,
    val onRollback: () -> Unit,
...
internal fun sqlConsolePageCallbacks(
    ...
    return SqlConsolePageCallbacks(
        ...
        onToggleSourceGroup = libraryBindings::toggleSourceGroup,
        ...
        onApplyExecutionHistory = libraryBindings::applyExecutionHistory,
        onRepeatExecutionHistory = libraryBindings::repeatExecutionHistory,
        ...
        onExplainCurrent = executionBindings::explainCurrent,
        onExplainAnalyzeCurrent = executionBindings::explainAnalyzeCurrent,
        onExplainSelection = executionBindings::explainSelection,
        onExplainAnalyzeSelection = executionBindings::explainAnalyzeSelection,
